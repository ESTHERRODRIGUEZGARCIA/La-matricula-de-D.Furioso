...
email_text = """
From - Fri Aug 18 06:25:23 2017
X-Mozilla-Status: 0001
X-Mozilla-Status2: 00800000
X-Mozilla-Keys:                                                                                 
Subject: =?UTF-8?Q?Re:_Consulta_sobre_mi_Ubicaci=c3=b3n?=
To: Donal Furioso <duck.furybear@gmail.com>
References: <CAEPjOfuKsTVEJ7-eZvQ3JTc5h_f3RND=xD1VV7h4zk65=i_rPw@mail.gmail.com>
From: Elustondo Raimundo <estacionamiento_autorizado133@outlook.es>
Message-ID: <10febcb2-cbeb-7fc2-1f7a-05ef0d594ed1@outlook.es>
Date: Fri, 18 Aug 2017 06:25:15 -0400
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.3.0
MIME-Version: 1.0
In-Reply-To: <CAEPjOfuKsTVEJ7-eZvQ3JTc5h_f3RND=xD1VV7h4zk65=i_rPw@mail.gmail.com>
Content-Type: multipart/alternative;
 boundary="------------58D471B604DDA6E484E02544"
Content-Language: es-ES

This is a multi-part message in MIME format.
--------------58D471B604DDA6E484E02544
Content-Type: text/plain; charset=utf-8; format=flowed
Content-Transfer-Encoding: 8bit

Buenos días Mr.Furioso.

Para atender su consulta necesitamos que nos facilite el número de 
matricula del automovil y la fecha de matriculación , asi como el color 
, marca y modelo del mismo. Sin todos estos datos no nos es posible 
identificarlo y poder garantizar que es suyo.

Si su amnesia se lo permite lo necesitamos a la mayor brevedad, o al 
final de semana serán retirados al desguace todos los coches en su misma 
situación.
...
El 18/08/17 a las 06:17, Donal Furioso escribió:
> Estimado director del parking número 133.
>
> Hoy he tenido un percance a la salida de la calle 133,🤒🤒 he sufrido 
> una amnesia por una brusca caída y no recuerdo en que planta de su 
> garaje he dejado mi automóvil.
>
> ¿Podría ayudarme?😟
>
> Saludos cordiales.
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    <div id="Signature">
      <div id="divtagdefaultwrapper" style="font-size: 12pt; color:
        rgb(0, 0, 0); background-color: rgb(255, 255, 255); font-family:
Calibri,Arial,Helvetica,sans-serif,&quot;EmojiFont&quot;,&quot;Apple
        Color Emoji&quot;,&quot;Segoe UI
        Emoji&quot;,NotoColorEmoji,&quot;Segoe UI
        Symbol&quot;,&quot;Android Emoji&quot;,EmojiSymbols;">
        <hr
style="width:320px; height:4px; border-width:0px;
          background-color:#fd7832; margin-left:0px">
...
--------------58D471B604DDA6E484E02544--
From - Fri Aug 18 06:36:19 2017
X-Mozilla-Status: 0001
X-Mozilla-Status2: 00800000
X-Mozilla-Keys:                                                                                 
Subject: =?UTF-8?Q?Re:_Consulta_sobre_mi_Ubicaci=c3=b3n?=
To: Donal Furioso <duck.furybear@gmail.com>
References: <CAEPjOfvX5AfyzE=i5fpL6gGjLF9gJgRwVT6Wa_AekcSf7nCTRQ@mail.gmail.com>
From: Elustondo Raimundo <estacionamiento_autorizado133@outlook.es>
Message-ID: <5ef2eb52-925c-546e-99cf-e9be8c877a75@outlook.es>
Date: Fri, 18 Aug 2017 06:36:10 -0400
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.3.0
MIME-Version: 1.0
In-Reply-To: <CAEPjOfvX5AfyzE=i5fpL6gGjLF9gJgRwVT6Wa_AekcSf7nCTRQ@mail.gmail.com>
Content-Type: multipart/alternative;
 boundary="------------DC110DF8F943DAD967E950B5"
Content-Language: es-ES

This is a multi-part message in MIME format.
--------------DC110DF8F943DAD967E950B5
Content-Type: text/plain; charset=utf-8; format=flowed
Content-Transfer-Encoding: 8bit

Buen dia,

Señor Donal le ruego acepte mis disculpas bajo ningun concepto era de mi 
intención faltarle al respeto.

Le facilitaremos las hojas de reclamaciones y por las molestias 
ocasionadas le regalamos un lavado de coche, para cuando lo recoja lo 
tenga brillante .
...
> *Donal Furioso*
>>
> El 18 de agosto de 2017, 12:25, Estacionamiento Autorizado 
> <estacionamiento_autorizado133@outlook.es 
> <mailto:estacionamiento_autorizado133@outlook.es>> escribió:
>
>     Buenos días Mr.Furioso.
>
>     Para atender su consulta necesitamos que nos facilite el número de
>     matricula del automovil y la fecha de matriculación , asi como el
>     color , marca y modelo del mismo. Sin todos estos datos no nos es
>     posible identificarlo y poder garantizar que es suyo.
>
>     Si su amnesia se lo permite lo necesitamos a la mayor brevedad, o
>     al final de semana serán retirados al desguace todos los coches en
>     su misma situación.
>
>     ------------------------------------------------------------------------
...
>>     Estimado director del parking número 133.
>>
>>     Hoy he tenido un percance a la salida de la calle 133,🤒🤒 he
>>     sufrido una amnesia por una brusca caída y no recuerdo en que
>>     planta de su garaje he dejado mi automóvil.
>>
>>     ¿Podría ayudarme?😟
>>
>>     Saludos cordiales.
...
# Expresión regular para encontrar la matrícula del coche
pattern = r"Matricula: ([A-Z0-9-]+)"

# Buscar todas las coincidencias de la matrícula en el texto del correo electrónico
matches = re.findall(pattern, email_text)

# Mostrar las coincidencias encontradas
if matches:
    print("Matrícula del coche encontrada:", matches[0])
else:
    print("No se encontró la matrícula del coche en el texto.")
